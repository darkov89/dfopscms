...
4. AI: „Generuj w tym języku” + „Zlokalizuj z PL → EN”; przy dodaniu locale wybór **AI vs ręcznie**; `meta.translationMode`; po zmianie PL pytanie o sync innych języków.
5. `DFOPS_planAllowsExtraLocales(plan)` — Standard / Custom; Starter = upsell.
6. Panel admina DFCMS: **PL only** (tłumaczenie przeglądarki OK) — nie mylić z i18n treści stron.
