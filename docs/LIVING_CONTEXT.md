...
| Data | Co |
|------|-----|
| 2026-05-22 | **Supabase Data API:** migracja **`20260522104231_explicit_grants_pages.sql`** — jawne `GRANT` na `public.pages` (`anon` SELECT; `authenticated` + `service_role` pełny CRUD). Wdrożyć: **`supabase db push`**. |
