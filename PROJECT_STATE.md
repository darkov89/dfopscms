...
**Ostatnia aktualizacja treści:** 2026-05-03 (wieczór — demo opinie/mapa, panel subskrypcji)
...
| **Bezpieczeństwo treści** | Sanityzacja przy zapisie strony (`pageRepository.sanitizeContent` + DOMPurify w panelu) — patrz sekcja SECURITY. Pola **mapy:** dozwolony iframe URL tylko dla hostów Google z **`/maps/embed`** lub klasycznego **`/maps?…&output=embed`**. |
