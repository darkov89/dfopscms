...
(function () {
  ...
  const COMPARISON_ROWS = [
    {
      label: 'Twoja rola',
      legacy: 'Budujesz stronę od zera, szukasz zdjęć i walczysz z układem',
      dfcms: 'Wpisujesz podstawowe dane firmy i cennik – reszta układa się sama.',
      dfcmsWin: true,
    },
    {
      label: 'Koszty',
      legacy: 'Niskie na start, pełne niespodzianek przy przedłużeniu za rok',
      dfcms: 'Pełna przejrzystość. Jedna, stała cena.',
      dfcmsWin: true,
    },
    {
      label: 'Rozwój',
      legacy: 'Martwisz się o aktualizacje i wirusy',
      dfcms: 'Technologia działa w tle, a Ty po prostu przyjmujesz klientów.',
      dfcmsWin: true,
    },
  ];
  ...
  const NICHES = [
    {
      ...
      demoHref: 'router.html?site=demo-gastro',
    ...
    },
    {
      ...
      demoHref: 'router.html?site=demo-care',
      demoLabel: 'Zobacz demo na żywo',
      external: true,
    ...
    },
    {
      ...
      demoHref: 'router.html?site=demo-fitness',
      demoLabel: 'Zobacz demo na żywo',
      external: true,
    ...
    },
    {
      ...
      demoHref: 'router.html?site=demo-beauty',
      demoLabel: 'Zobacz demo na żywo',
      external: true,
    ...
    },
    {
      ...
      demoHref: 'router.html?site=demo-services',
      demoLabel: 'Zobacz demo na żywo',
      external: true,
    ...
    },
    {
      ...
      demoHref: 'router.html?site=demo-consultant',
      demoLabel: 'Zobacz demo na żywo',
      external: true,
