...
(function () {
  ...
  const COMPARISON_ROWS = [
    {
      label: 'Cena po pierwszym roku',
      dfcms: 'Stała — bez ukrytej podwyżki',
      legacy: 'Często „pierwszy rok za 2 zł”, potem pełna stawka',
      dfcmsWin: true,
    },
    {
      label: 'Czas wdrożenia',
      dfcms: 'Gotowa strona w ~60 sekund',
      legacy: 'Godziny układania sekcji i szablonów',
      dfcmsWin: true,
    },
    {
      label: 'Szablon pod branżę',
      dfcms: 'Jeden dopracowany layout na niszę',
      legacy: 'Setki generycznych motywów do ręcznej edycji',
      dfcmsWin: true,
    },
    {
      label: 'Opinie Google na stronie',
      dfcms: 'Wbudowana synchronizacja + opinie własne',
      legacy: 'Wtyczki, osadzenia lub ręczna praca',
      dfcmsWin: true,
    },
    {
      label: 'Rezerwacje (Booksy, Calendly…)',
      dfcms: 'Widget lub przycisk — konfiguracja w panelu',
      legacy: 'Osobne narzędzia i sklejanie linków',
      dfcmsWin: true,
    },
    {
      label: 'SSL, hosting, aktualizacje',
      dfcms: 'W abonamencie — bez panelu hostingowego',
      legacy: 'Osobny hosting + kreator + domena',
      dfcmsWin: true,
    },
  ];
