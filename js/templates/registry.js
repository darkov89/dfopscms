  ...
  const templatesV3 = {
    ...
    consultant: {
      pl: {
        ...
        google_reviews: { label: 'Zaufanie', embed_url: "", place_query: "", max_reviews: 6, title: "Opinie z Google", cached_reviews: [] },
        gallery: { title: "Nasze realizacje", images: [] },
        seo: {
    ...
    beauty: {
      pl: {
        ...
        social: { facebook: "", instagram: "", tiktok: "" },
        google_reviews: { embed_url: "", place_query: "", max_reviews: 6, title: "Opinie z Google", cached_reviews: [] },
        reviews: [],
        reviews_heading: { label: 'Głos klientów', title: 'Opinie klientów' },
        gallery: { title: "Nasze realizacje", images: [] },
        seo: {
    ...
    fitness: {
      pl: {
        ...
        social: { facebook: "", instagram: "", tiktok: "" },
        google_reviews: { embed_url: "", place_query: "", max_reviews: 6, title: "Opinie klientów", cached_reviews: [] },
        reviews: [],
        reviews_heading: { label: 'Głos klientów', title: 'Opinie klientów' },
